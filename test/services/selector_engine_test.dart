...
<table>
  ...
  <tr><td class="rowhead">分享率</td><td>2.5</td></tr>
      ...
      final r = SelectorEngine.query(
          doc.documentElement!, "td.rowhead:contains('魔力值') + td");
      expect(r, hasLength(1));
...
<table>
  ...
  <tr><td class="rowhead">Karma</td><td>nope</td></tr>
      ...
      final r = SelectorEngine.query(doc.documentElement!,
...
<table>
  <tr><td class="rowhead">等级</td>
      ...
      final r = SelectorEngine.query(
          doc.documentElement!, "td.rowhead:contains('等级') + td > img");
      expect(r, hasLength(1));
    ...
    test('找不到匹配返回空', () {
      ...
      expect(
          SelectorEngine.query(
              doc.documentElement!, "td:contains('nope') + td"),
          isEmpty);
    });
  });
  ...
  group('Filters', () {
    ...
    test('parseSize 二进制单位', () {
      expect(Filters.apply('1.5 TiB', 'parseSize'),
    ...
    test('parseSize 取首段', () {
      expect(Filters.apply('上传量: 1.23 TB (实际 2x)', 'parseSize'),
